"""
Django settings for WCHDProject project.
...
ROOT_URLCONF = 'WCHDProject.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'WCHDApp' / 'templates',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'WCHDProject.wsgi.application'
